    ...
    <div ref={ref} className="relative w-full flex items-center justify-center min-h-[400px] lg:min-h-[500px]">
      ...
      >
        ...
        <motion.path 
          ...
          fill="#C3A78A"
          variants={bottomLeftPart}
          initial="hidden"
          animate={isInView ? "visible" : "hidden"}
          style={{ originX: 0.5, originY: 0.5 }}
        />
        
        {/* Text "STEELSOLUTIONS" - always visible, no animation */}
        <path 
          ...
          style={{ transition: "opacity 0.3s ease-in-out 1.8s" }}
        />
      </motion.svg>
    </div>
  );
